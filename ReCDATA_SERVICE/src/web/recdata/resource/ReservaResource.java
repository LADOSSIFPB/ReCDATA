...
public class ReservaResource {
	...
	@Consumes("application/json")
	@Produces("application/json")
	public Response  isExisteReserva(ReservaItem reservaConsulta) throws SQLException {
		System.out.println(new ReservaController().isExisteReserva(reservaConsulta));
			Response response = new ReservaController().isExisteReserva(reservaConsulta);
