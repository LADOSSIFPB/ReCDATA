 ...
 */
public class ListaItemReCDATAExceptionAlertDialog{

    private Activity activity;

    public ListaItemReCDATAExceptionAlertDialog(Activity activity) {
    ...
    public void showAlertDialog() {
        ...
        alertDialog.setTitle("Erro ao tentar lista as Informações!");
