...
public class Constantes {
	...
	public static String MSG_ErroCampoData = "Data n„o Informada!";//corregido
	public static String MSG_ErroCampoHora = "Hor·rio n„o Informado!";//corrigido
	public static String MSG_ErroCampoDataNoEquals = "As Datas devem ser as mesmas!";
	...
	public static String MSG_ErroCampoTelefone ="Telefone preenchido inv·lido(siga o exemplo!)";
	public static String MSG_ErroCampoEndereco ="EndereÁo  preenchido inv·lido(MIN 20 - MAX 70 Caracteres!)";
